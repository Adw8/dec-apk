...
import dev.kdrag0n.virtcontainer.ui.container.details.ContainerDetailsFragment;

/* renamed from: fQw  reason: default package */
/* loaded from: classes.dex */
public abstract class fQw extends E5 implements iLf {
    ...
    public final void V(Activity activity) {
        ...
        if (!this.y) {
            this.y = true;
            ContainerDetailsFragment containerDetailsFragment = (ContainerDetailsFragment) this;
            ((aOY) R()).getClass();
        }
    }
    ...
    public final void f() {
        if (this.f3420R == null) {
            this.f3420R = new d(super.H(), this);
