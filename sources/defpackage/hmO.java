...
import dev.kdrag0n.virtcontainer.ui.settings.forward.PortForwardFragment;

/* renamed from: hmO  reason: default package */
/* loaded from: classes.dex */
public abstract class hmO extends E5 implements iLf {
    ...
    public final void f() {
        if (this.f4377R == null) {
            this.f4377R = new d(super.H(), this);
