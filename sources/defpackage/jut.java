...
public final class jut implements bF9 {
    public static final jut R = new jut();
    ...
    public final mET v(mZf mzf, List list, long j) {
        ...
        if (size == 0) {
            ...
            return mzf.f(i2, i, iia.R, new Cp(4, arrayList));
        } else {
            l0f L = ((pc0) list.get(0)).L(j);
            return mzf.f(L.e, L.X, iia.R, new kW9(L, 6));
        }
    }
}
