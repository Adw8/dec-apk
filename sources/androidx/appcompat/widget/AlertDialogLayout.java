...
public class AlertDialogLayout extends lYU {
    ...
    public final void onLayout(boolean r10, int r11, int r12, int r13, int r14) {
        ...
        L_0x0050:
            ...
            eGR r6 = (defpackage.eGR) r6
            int r7 = r6.gravity
            if (r7 >= 0) goto L_0x0073
            r7 = r2
        L_0x0073:
            java.util.WeakHashMap r8 = defpackage.of5.f6887R
            int r8 = defpackage.eHQ.e(r9)
        ...
        if (mode2 != 1073741824) {
            ...
            for (int i12 = 0; i12 < childCount; i12++) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) egr).width == -1) {
                        int i13 = ((LinearLayout.LayoutParams) egr).height;
                        ((LinearLayout.LayoutParams) egr).height = childAt3.getMeasuredHeight();
                        measureChildWithMargins(childAt3, makeMeasureSpec, 0, i2, 0);
                        ((LinearLayout.LayoutParams) egr).height = i13;
                    }
                }
            }
        }
